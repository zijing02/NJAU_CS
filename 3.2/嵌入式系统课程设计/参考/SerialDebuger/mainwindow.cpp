    ...
    , ui(new Ui::MainWindow)
{
    ...
    lblLinkBlog->setText("<style> a {text-decoration: none} </style> <a href=\"https://www.njau.edu.cn/?c=0\">南京农业大学");// 无下划线
    QLabel *lblLinkSource = new QLabel(this);
    lblLinkSource->setOpenExternalLinks(true);
    lblLinkSource->setText("<style> a {text-decoration: none} </style> <a href=\"https://myportal.njau.edu.cn/new/index.html\">办事大厅");// 无下划线
...
void MainWindow::serialPortRead_Slot()
{
    ...
    // 判断是否为16进制接收，将以后接收的数据全部转换为16进制显示
