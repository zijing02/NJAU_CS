...
def main():
    ...
    if args.dataset_name == 'ave_avvp_va':
        ...
        val_csv_path = 'data/AVE_AVVP/AVE_AVVP_eval_visual_checked_combined.csv'
        audio_fea_base_path = 'data/AVVP/feature/audio/zip'
        video_fea_base_path = 'data/AVVP/feature/video/zip'
        data_root = 'data/AVE_AVVP'
        train_dataloader = DataLoader(
