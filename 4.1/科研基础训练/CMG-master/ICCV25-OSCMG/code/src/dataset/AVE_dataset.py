...
class AVEDataset(Dataset):
    def __init__(self, data_root, split='train'):
        ...
        if split == '14':
            self.sample_order_path = 'data/OSCMG(cvpr25)/data/AVE_OSCMG/train_order_14class.h5'
        elif split == '21':
            self.sample_order_path = 'data/OSCMG(cvpr25)/data/AVE_OSCMG/train_order_21class.h5'
        else:
