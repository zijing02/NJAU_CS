...
from model.CPC import Cross_CPC, Cross_CPC_AVT, Cross_Mask_CPC_AVT, Cross_Mask2_CPC_AVT
...
def main():
    ...
    if args.dataset_name == 'ave':
        ...
        meta_csv_path = 'data/feature_extractor/feature_extractor/vggsound-avel40k.csv'
        audio_fea_base_path = 'data/vggsound40k/feature/audio/zip'
        video_fea_base_path = 'data/vggsound40k/feature/video/zip'
        train_dataloader = DataLoader(
